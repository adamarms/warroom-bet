...
async function fOdds() {
  try {
    ...
    rows.forEach(r => {
      ...
      // Zero-pad hour for correct string sorting (6:34 → 06:34)
      const padTime = pullTime.includes(":") && pullTime.indexOf(":") < 2 ? "0" + pullTime : pullTime;
      const sortKey = `${pullDate}_${padTime}`;
