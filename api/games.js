...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const games = assembled.map((g, i) => {
      const r = results[i] || {};
      // Check if game has started — if so, don't show live odds as pre-game analysis
      ...
      return {
        ...
        aL: g.aL, hL: g.hL,
        dkMl: commenced ? null : g.dkMl, fdMl: commenced ? null : g.fdMl,
        // Engine results — null out if game is live
        aP: commenced ? null : r.aP, hP: commenced ? null : r.hP,
        aI: commenced ? null : r.aI, hI: commenced ? null : r.hI,
        aE: commenced ? null : r.aE, hE: commenced ? null : r.hE,
        side: commenced ? null : r.side, edge: commenced ? null : r.edge,
        playTeam: commenced ? null : r.playTeam, playOdds: commenced ? null : r.playOdds,
        projTotal: commenced ? null : r.projTotal, pf: r.pf,
        wind: r.wind,
        ouLines: commenced ? [] : r.ouLines, bestOu: commenced ? null : r.bestOu,
        rrl: commenced ? null : r.rrl,
        live: commenced,
        error: commenced ? "LIVE" : r.error
      };
    });
